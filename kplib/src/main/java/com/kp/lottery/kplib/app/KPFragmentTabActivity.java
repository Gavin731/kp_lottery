...
public class KPFragmentTabActivity extends KPActivity {

	private static final String LOG_TAG = KPFragmentTabActivity.class
			.getSimpleName();
	...
	public static class TabManager implements TabHost.OnTabChangeListener {
		private final KPFragmentTabActivity mActivity;
		...
		public TabManager(KPFragmentTabActivity activity, TabHost tabHost,
                          int containerId) {
			mActivity = activity;
			mTabHost = tabHost;
