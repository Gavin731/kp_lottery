...
public class TitleBar {
    ...
    private void initCustomTitle() {
        ...
        mActivity.getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.item_default_title_bar);
